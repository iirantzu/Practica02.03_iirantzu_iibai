...
print("Nombre en minusculas:", nombre_usuario.lower(), end="\n")
print("Nombre en mayusculas:", nombre_usuario.upper(), end="\n")
print("Nombre en camel case:", nombre_usuario.title(), end="\n")